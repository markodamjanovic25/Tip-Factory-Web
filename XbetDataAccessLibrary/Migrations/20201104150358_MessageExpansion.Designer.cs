...
namespace DataAccessLibrary.Migrations
{
    ...
    [Migration("20201104150358_MessageExpansion")]
    partial class MessageExpansion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Bet", b =>
                {
                    ...
                    b.Property<int>("PredictionPosition")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Match", b =>
                {
                    ...
                    b.Property<int?>("ClubAwayGoalsHalf")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ClubHomeGoalsHalf")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Plan", b =>
                {
                    ...
                    b.Property<string>("AdventurousTipsAmount")
                        .HasColumnType("nvarchar(25)")
                        .HasMaxLength(25);

                    b.Property<string>("MonotonousTipsAmount")
                        .HasColumnType("nvarchar(25)")
                        .HasMaxLength(25);
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Message", b =>
                {
                    b.HasOne("DataAccessLibrary.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("DataAccessLibrary.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Subscription", b =>
                {
                    b.HasOne("DataAccessLibrary.Models.Plan", "Plan")
